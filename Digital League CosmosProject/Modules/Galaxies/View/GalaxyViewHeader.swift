...
class GalaxyViewHeader: UITableViewHeaderFooterView {
    //MARK: - Properties
    ...
    lazy var nameOfGalaxyLabel: UILabel = {
       var label = UILabel()
...
extension GalaxyViewHeader: ConfigureHeaderBackgroundProtocol {
...
extension GalaxyViewHeader: ConfigureViewProtocol {
    func configureView() {
        ...
        NSLayoutConstraint.activate([
            ...
            nameOfGalaxyLabel.topAnchor.constraint(equalTo: customHeaderView.topAnchor, constant: 20),
            nameOfGalaxyLabel.leadingAnchor.constraint(equalTo: customHeaderView.leadingAnchor, constant: 20),
            nameOfGalaxyLabel.trailingAnchor.constraint(equalTo: customHeaderView.trailingAnchor, constant: -20),
            nameOfGalaxyLabel.bottomAnchor.constraint(equalTo: customHeaderView.bottomAnchor, constant: -20),
        ])
    }
